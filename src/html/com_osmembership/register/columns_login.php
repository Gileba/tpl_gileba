...
<div class="<?php echo $controlGroupClass; ?>">
    <div class="<?php echo $controlLabelClass; ?>">
        <label for="login_username">
            <?php echo empty($this->config->use_email_as_username)
            	? Text::_("OSM_USERNAME")
            	: $fields["email"]->title; ?><span class="required">*</span>
        </label>
    </div>
    <div class="<?php echo $controlsClass; ?>">
        <input type="text" name="login_username" id="login_username" class="form-control<?php
        if (!$isJoomla4) {
        	echo " input-large";
        }
        echo $bootstrapHelper->getFrameworkClass("uk-input", 1);
        ?>" value=""/>
    </div>
</div>
<div class="<?php echo $controlGroupClass; ?>">
    ...
    <div class="<?php echo $controlsClass; ?>">
     ...
     if (OSMembershipHelper::isJoomla4()) {
     	echo OSMembershipHelperHtml::getPasswordInput("login_password", "", $passwordCssClass);
     	 ...
     	 ?>
		    <input type="password" id="login_password" name="login_password" class="<?php echo $passwordCssClass; ?>" value="" />
		<?php
     }
     ?>
    </div>
...
<div class="<?php echo $controlGroupClass; ?>">
    <div class="<?php echo $controlsClass; ?>">
        <input type="button" name="btnLoginButton" id="btnLoginButton" value="<?php echo Text::_(
        	"OSM_LOGIN"
        ); ?>" class="<?php echo $btnPrimaryClass; ?>" />
    </div>
</div>

<?php // Show forgot username and password if configured
